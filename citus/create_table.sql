...
select * from create_distributed_table('part', 'p_partkey');
select * from create_distributed_table('supplier', 's_suppkey');
select * from create_distributed_table('partsupp', 'ps_partkey');
select * from create_distributed_table('customer', 'c_custkey');
select * from create_distributed_table('orders', 'o_orderkey');
select * from create_distributed_table('lineitem', 'l_linenumber');
select * from create_distributed_table('nation', 'n_nationkey');
select * from create_distributed_table('region', 'r_regionkey');
